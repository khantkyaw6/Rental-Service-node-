...
const indexCity = async (req, res) => {
  ...
  return message(res, false, "City Lists", cities);
};
const storeCity = async (req, res) => {
  const city = await City.insertMany([
    {
      name: "Seoul",
      country: "South Korea",
      continent: "Asia",
  ...
  return message(res, false, "City created successfully", city);
};
module.exports = { indexCity, storeCity };
